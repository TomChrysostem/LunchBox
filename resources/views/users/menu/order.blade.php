@extends('users.navbar')
	@section('content')
		<div class="ftco-intro img" style="background-image: url('{{asset('images/lunchbox1.jpg')}}');">
				<div class="container">
						...
						<div class="row d-flex contact-info mb-5 mt-3">
							<div class="col-md-12 ftco-animate">
								<div class="box p-4 bg-light d-flex">
									<div class="card">
										<img class="card card-img img-responsive" src="{{ asset('storage/img/'.$menu->image) }}" alt="Card image"/>
										<div class="text-center d-flex align-items-center">
											<h4 class="card-title pt-2"><strong>{{$menu->menu}}</strong></h4>
										</div>
									</div>
								</div>
							</div>
