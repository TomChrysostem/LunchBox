					...
					<div>
							<ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
								<li class="nav-item p-3">
									<a type="button" class="btn btn btn-primary active" id="company-tab" data-toggle="tab" href="#company" role="tab" aria-controls="company"
									aria-selected="true">lunchbox</a>
								</li>
								<li class="nav-item p-3">
									<a type="button" class="btn btn btn-success" id="school-tab" data-toggle="tab" href="#school" role="tab" aria-controls="school"
								...
								<li class="nav-item p-3">
									<a type="button" class="btn btn btn-info" id="school-tab" data-toggle="tab" href="#school" role="tab" aria-controls="school"
