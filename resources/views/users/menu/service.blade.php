			...
			<section class="pt-5 bg-light pb-3 mb-4" id="lunchbox-section">
				<div class="container">
					...
					<div>
							<ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
								<li class="nav-item p-3">
									<a type="button" class="btn btn btn-primary" id="company-tab" data-toggle="tab" href="#company" role="tab" aria-controls="company"
									aria-selected="true">lunchbox</a>
								</li>
								<li class="nav-item p-3">
									<a type="button" class="btn btn btn-success" id="dinner-tab" data-toggle="tab" href="#dinner" role="tab" aria-controls="dinner"
									aria-selected="true">Dinner</a>
								</li>
								<li class="nav-item p-3">
									<a type="button" class="btn btn btn-warning" id="school-tab" data-toggle="tab" href="#school" role="tab" aria-controls="school"
									aria-selected="true">School lunch</a>
								</li>
								<li class="nav-item p-3">
									<a type="button" class="btn btn btn-info" id="side-dish-tab" data-toggle="tab" href="#side-dish" role="tab" aria-controls="side-dish"
									aria-selected="true">Side-dish</a>
								</li>
								<li class="nav-item p-3">
									<a type="button" class="btn btn btn-danger" id="eventlunch-tab" data-toggle="tab" href="#eventlunch" role="tab" aria-controls="eventlunch"
									aria-selected="false">Event food</a>
								</li>
								<li class="nav-item p-3">
									<a type="button" class="btn btn btn-secondary" id="how-order-tab" data-toggle="tab" href="#how-order" role="tab" aria-controls="how-order"
					...
					<div class="tab-content align-self-stretch ftco-animate mx-3" id="myTabContent">
						...
						<div class="tab-pane fade show" id="company" role="tabpanel" aria-labelledby="company-tab">	
							<div class="row justify-content-center mt-3">
								<div class="align-self-stretch ftco-animate mx-3">
									<div class="media-body">
									<p>The price and explanations</p>
						...
						<!--side dish-->
						<div class="tab-pane fade show" id="side-dish" role="tabpanel" aria-labelledby="side-dish-tab">
					...
					<!--how to order-->
						...
						<div class="tab-pane fade show" id="how-order" role="tabpanel" aria-labelledby="how-order-tab">	
