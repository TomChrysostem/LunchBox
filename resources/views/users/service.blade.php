	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="#side-school-event-section" class="nav-link"><span>Side-dish, School lunch & Event food</span></a></li>
...
<!-- side-school-event-section section-->
<section class="pt-5 bg-light" id="side-school-event-section">

      <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home"
            aria-selected="true"><h4>Side Dishes</h4></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile"
            aria-selected="false"><h4>School Lunch</h4></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact"
            aria-selected="false"><h4>Events Food</h4></a>
        </li>
      </ul>
<!--side dish-->
              ...
              <div class="row justify-content-center mt-3">
                    <div class="align-self-stretch ftco-animate mx-3">
                      <div class="media-body">
                        ...
                        <p>Let us provide the food for your next event. We promise your guests or clients will be delighted! We cater for corporate events, weddings, </p>
                      </div> 
                    </div>
	              </div>
...
<!--school lunch-->
        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <div class="row justify-content-center mt-3">
                    ...
                    <p class="mb-3 mx-3"><a href="#" class="btn btn-success px-4 py-3" data-toggle="modal" data-target="#Orderlunchbox">Order School Lunch</a></p>
	              </div>
...
<!--event food-->
        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                <div class="row justify-content-center mt-3">
                    ...
                    <p class="mb-3 mx-3"><a href="#" class="btn btn-success px-4 py-3" data-toggle="modal" data-target="#Orderlunchbox">Order Event Food</a></p>
	              </div>
