...
<main>
<div class="ftco-intro img" id="about-section" style="background-image: url(images/register.jpg);">
			<div class="container">
...
<div class="container">
        <div class="row justify-content-center mb-3 py-3">
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <h5 class="text-justified">You can Register by E-mail or by Contact Number or by Register Form</h5>
          </div>
        </div>
        ...
        <div class="row block-12">
          <div class="col-md-7 order-md-last d-flex ftco-animate">
            ...
            <form action="{{ route('attendees.store') }}" method="POST" class="bg-light p-4">
                ...
                <div class="form-group">
                  <label for="exampleFormControlSelect1">Courses</label>
                    <select class="form-control" name="course_id">
                        <option value="1">Japanese dishes</option>
                        <option value="2">Myanmar dishes</option>
                        <option value="3">Italian dishes</option>
                    </select>
