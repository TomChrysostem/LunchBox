    ...
    @csrf
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group mb-0">
                            ...
                            <input type="text" class="form-control" placeholder="Company" name="course">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group mb-0">
                            ...
                            <textarea class="form-control" placeholder="Description about course" name="description"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
        ...
        <div class="row">
            <div class="col-12 text-center p-3">
                ...
                <button type="submit" class="btn btn-info btn-round">Add Course</button>
            </div>
        </div>
    </form>
</div>
